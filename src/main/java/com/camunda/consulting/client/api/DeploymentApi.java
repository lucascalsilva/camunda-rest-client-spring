...
import com.camunda.consulting.client.model.DeploymentDto;
import com.camunda.consulting.client.model.DeploymentResourceDto;
import com.camunda.consulting.client.model.DeploymentWithDefinitionsDto;
import com.camunda.consulting.client.model.ExceptionDto;
import java.io.File;
import org.threeten.bp.OffsetDateTime;
import com.camunda.consulting.client.model.ParseExceptionDto;
import com.camunda.consulting.client.model.RedeploymentDto;
...
@Component("com.camunda.consulting.client.api.DeploymentApi")
public class DeploymentApi {
     ...
     * <p><b>400</b> - Bad Request. In case one of the bpmn resources cannot be parsed.  See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#parse-exceptions) for the error response format.
     ...
     */
    public DeploymentWithDefinitionsDto createDeployment(String tenantId, String deploymentSource, Boolean deployChangedOnly, Boolean enableDuplicateFiltering, String deploymentName, File data) throws RestClientException {
        return createDeploymentWithHttpInfo(tenantId, deploymentSource, deployChangedOnly, enableDuplicateFiltering, deploymentName, data).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<DeploymentWithDefinitionsDto> createDeploymentWithHttpInfo(String tenantId, String deploymentSource, Boolean deployChangedOnly, Boolean enableDuplicateFiltering, String deploymentName, File data) throws RestClientException {
     ...
     * <p><b>404</b> - A Deployment with the provided id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>404</b> - Deployment with given id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param id The id of the deployment. (required)
     * @return List&lt;DeploymentDto&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<DeploymentDto> getDeployment(String id) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<DeploymentDto>> getDeploymentWithHttpInfo(String id) throws RestClientException {
        Object postBody = null;
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>404</b> - Deployment Resource with given resource id or deployment id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param id The id of the deployment (required)
     ...
     * <p><b>400</b> - Deployment Resource with given resource id or deployment id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param id The id of the deployment. (required)
     * @param resourceId The id of the deployment resource. (required)
     * @return File
     * @throws RestClientException if an error occurs while attempting to invoke the API
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>404</b> - Deployment resources for the given deployment do not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Returned if some of the query parameters are invalid, for example, if an invalid operator for variable comparison is used. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param id Filter by deployment id (optional)
     * @param name Filter by the deployment name. Exact match. (optional)
     * @param nameLike Filter by the deployment name that the parameter is a substring of. The parameter can include the wildcard &#x60;%&#x60; to express like-strategy such as: starts with (&#x60;%&#x60;name), ends with (name&#x60;%&#x60;) or contains (&#x60;%&#x60;name&#x60;%&#x60;). (optional)
     * @param source Filter by the deployment source. (optional)
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>404</b> - Deployment or a deployment resource for the given deployment does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
