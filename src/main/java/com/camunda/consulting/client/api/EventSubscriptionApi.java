...
import com.camunda.consulting.client.model.EventSubscriptionDto;
...
@Component("com.camunda.consulting.client.api.EventSubscriptionApi")
public class EventSubscriptionApi {
     ...
     * <p><b>400</b> - Bad Request Returned if some of the query parameters are invalid, for example if a &#x60;sortOrder&#x60; parameter is supplied, but no &#x60;sortBy&#x60;. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
