...
import com.camunda.consulting.client.model.ActivityStatisticsResultDto;
...
import java.io.File;
import com.camunda.consulting.client.model.FormDto;
import com.camunda.consulting.client.model.HistoryTimeToLiveDto;
import org.threeten.bp.OffsetDateTime;
import com.camunda.consulting.client.model.ProcessDefinitionDiagramDto;
import com.camunda.consulting.client.model.ProcessDefinitionDto;
import com.camunda.consulting.client.model.ProcessDefinitionStatisticsResultDto;
import com.camunda.consulting.client.model.ProcessDefinitionSuspensionStateDto;
import com.camunda.consulting.client.model.ProcessInstanceDto;
import com.camunda.consulting.client.model.ProcessInstanceWithVariablesDto;
import com.camunda.consulting.client.model.RestartProcessInstanceDto;
import com.camunda.consulting.client.model.StartProcessInstanceDto;
import com.camunda.consulting.client.model.StartProcessInstanceFormDto;
...
@Component("com.camunda.consulting.client.api.ProcessDefinitionApi")
public class ProcessDefinitionApi {
     ...
     * <p><b>404</b> - Not found Process definition with given id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     ...
     * <p><b>204</b> - Request successful.
     * <p><b>403</b> - Forbidden The process definitions with the given &#x60;key&#x60; cannot be deleted due to missing permissions. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - Not found Process definition with given &#x60;key&#x60; does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
    ...
    public ResponseEntity<Void> deleteProcessDefinitionsByKeyAndTenantIdWithHttpInfo(String key, String tenantId, Boolean cascade, Boolean skipCustomListeners, Boolean skipIoMappings) throws RestClientException {
        ...
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}", uriVariables);
     ...
     * <p><b>400</b> - Returned if some of the query parameters are invalid. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - Process definition with given key does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
    ...
    public ResponseEntity<List<ActivityStatisticsResultDto>> getActivityStatisticsByProcessDefinitionKeyAndTenantIdWithHttpInfo(String key, String tenantId, Boolean failedJobs, Boolean incidents, String incidentsForType) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/statistics", uriVariables);
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - The form key has wrong format.  See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>403</b> - The deployed start form cannot be retrieved due to missing permissions on process definition resource. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - No deployed start form for a given process definition exists. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
    ...
    public ResponseEntity<File> getDeployedStartFormByKeyAndTenantIdWithHttpInfo(String key, String tenantId) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/deployed-start-form", uriVariables);
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Process definition with given &#x60;key&#x60; does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param key The key of the process definition (the latest version thereof) to be retrieved. (required)
     * @param tenantId The id of the tenant the process definition belongs to. (required)
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Process definition with given &#x60;id&#x60; does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Returned if some of the query parameters are invalid. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>403</b> - The Process Definition xml cannot be retrieved due to missing permissions on the Process Definition resource. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - Process definition with given id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param id The id of the process definition. (required)
    ...
    public ResponseEntity<ProcessDefinitionDiagramDto> getProcessDefinitionBpmn20XmlByKeyAndTenantIdWithHttpInfo(String key, String tenantId) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/xml", uriVariables);
    ...
    public ResponseEntity<File> getProcessDefinitionDiagramByKeyAndTenantIdWithHttpInfo(String key, String tenantId) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/diagram", uriVariables);
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Returned if some of the query parameters are invalid, for example if a &#x60;sortOrder&#x60; parameter is supplied, but no &#x60;sortBy&#x60;. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Process definition has no form field metadata defined. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - Process definition with given id does not exist.  See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
    ...
    public ResponseEntity<File> getRenderedStartFormByKeyAndTenantIdWithHttpInfo(String key, String tenantId) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/rendered-form", uriVariables);
     ...
     * <p><b>200</b> - Request successful.
     * <p><b>400</b> - Process definition has no start form defined. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - Process definition with given id does not exist.  See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
    ...
    public ResponseEntity<FormDto> getStartFormByKeyAndTenantIdWithHttpInfo(String key, String tenantId) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/startForm", uriVariables);
     ...
     * <p><b>404</b> - The id is null or does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     ...
     * <p><b>200</b> - Request successful. A JSON object containing a property for each variable returned.
     * <p><b>404</b> - The key is null or does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param key The key of the process definition (the latest version thereof) to be retrieved. (required)
     * @param variableNames A comma-separated list of variable names. Allows restricting the list of requested variables to the variable names in the list. It is best practice to restrict the list of variables to the variables actually required by the form in order to minimize fetching of data. If the query parameter is ommitted all variables are fetched. If the query parameter contains non-existent variable names, the variable names are ignored. (optional)
     * @param deserializeValues Determines whether serializable variable values (typically variables that store custom Java objects) should be deserialized on server side (default true).  If set to true, a serializable variable will be deserialized on server side and transformed to JSON using [Jackson&#39;s](http://jackson.codehaus.org/) POJO/bean property introspection feature. Note that this requires the Java classes of the variable value to be on the REST API&#39;s classpath.  If set to false, a serializable variable will be returned in its serialized format. For example, a variable that is serialized as XML will be returned as a JSON string containing XML.  **Note**: While true is the default value for reasons of backward compatibility, we recommend setting this parameter to false when developing web applications that are independent of the Java process applications deployed to the engine. (optional, default to true)
     * @return Map&lt;String, VariableValueDto&gt;
    ...
    public ResponseEntity<Map<String, VariableValueDto>> getStartFormVariablesByKeyAndTenantIdWithHttpInfo(String key, String tenantId, String variableNames, Boolean deserializeValues) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/form-variables", uriVariables);
     ...
     * <p><b>500</b> - The instance could not be created successfully. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * @param id The id of the process definition to be retrieved. (required)
    ...
    public ResponseEntity<ProcessInstanceWithVariablesDto> startProcessInstanceByKeyAndTenantIdWithHttpInfo(String key, String tenantId, StartProcessInstanceDto startProcessInstanceDto) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/start", uriVariables);
    ...
    public ResponseEntity<ProcessInstanceDto> submitFormByKeyAndTenantIdWithHttpInfo(String key, String tenantId, StartProcessInstanceFormDto startProcessInstanceFormDto) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/submit-form", uriVariables);
     ...
     * <p><b>204</b> - Request successful.
     * <p><b>400</b> - Returned if some of the request parameters are invalid. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
     * <p><b>404</b> - Process definition with given id does not exist. See the [Introduction](https://docs.camunda.org/manual/7.13/reference/rest/overview/#error-handling) for the error response format.
    ...
    public ResponseEntity<Void> updateHistoryTimeToLiveByProcessDefinitionKeyAndTenantIdWithHttpInfo(String key, String tenantId, HistoryTimeToLiveDto historyTimeToLiveDto) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/history-time-to-live", uriVariables);
    ...
    public ResponseEntity<Void> updateProcessDefinitionSuspensionStateByKeyAndTenantIdWithHttpInfo(String key, String tenantId, ProcessDefinitionSuspensionStateDto processDefinitionSuspensionStateDto) throws RestClientException {
        ...
        uriVariables.put("key", key);
        uriVariables.put("tenant-id", tenantId);
        String path = apiClient.expandPath("/process-definition/key/{key}/tenant/{tenant-id}/suspended", uriVariables);
