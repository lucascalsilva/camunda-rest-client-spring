...
@Component("com.camunda.consulting.client.api.ProcessInstanceApi")
public class ProcessInstanceApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public Map<String, VariableValueDto> getProcessInstanceVariables(String id, Boolean deserializeValue) throws RestClientException {
        return getProcessInstanceVariablesWithHttpInfo(id, deserializeValue).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Map<String, VariableValueDto>> getProcessInstanceVariablesWithHttpInfo(String id, Boolean deserializeValue) throws RestClientException {
        Object postBody = null;
